from Building.IDocument import IDocument, ITerm , DocumentIdentifier
    ...
    def __init__(self, doc_id: Path):
        ...
        try:
            with open(doc_id) as f:
                self.term_list: list[ITerm] = list(DIDAndStreamsGenerator.stream_overall_transformation_applied_on_file(f))
